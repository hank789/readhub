...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may configure your mySQL driver settings. mySQL driver is simple
    | yet powerful enough for our application. In the future we may wanna move
    | to other solutions such as ElasticSearch. But not yet!
    |
    */
