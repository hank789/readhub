 ...
 * Generated for Laravel 5.4.30 on 2017-08-07.
 *
...
namespace Flugg\Responder\Facades { 
    ...
    class Responder {
         ...
         * @static 
         */ 
        public static function error($errorCode = null, $statusCode = null, $message = null)
        {
            return \Flugg\Responder\Responder::error($errorCode, $statusCode, $message);
        }
         ...
         * @static 
         */ 
        public static function success($data = null, $statusCode = null, $meta = array())
        {
            return \Flugg\Responder\Responder::success($data, $statusCode, $meta);
        }
